...
package iteracion2.Alohandes.interfazApp;
...
//			e.printStackTrace ();
    ...
    public void adicionarTipoBebida( )
    {
    	try 
    	{
    		...
    		if (nombreTipo != null)
    		{
        		VOHabitacionServicio tb = parranderos.adicionarTipoBebida (nombreTipo);
        		if (tb == null)
        		{
...
//			e.printStackTrace();
    ...
    public void buscarTipoBebidaPorNombre( )
    {
    	try 
    	{
    		...
    		if (nombreTb != null)
    		{
    			VOHabitacionServicio tipoBebida = parranderos.darTipoBebidaPorNombre (nombreTb);
